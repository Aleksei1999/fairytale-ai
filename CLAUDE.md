...
| Тариф | Цена | Что даёт |
|-------|------|----------|
| Free Trial | $0 | 7 дней, 3 сказки (без AI Audio) |
| Monthly | $8 первый месяц, потом $29/мес | Подписка 30 дней (безлимит сказок + AI Audio за звёзды) |
...
| Действие | Стоимость |
|----------|-----------|
| Генерация сказки | Бесплатно (для подписчиков безлимит, Free Trial - 3 сказки) |
| Озвучка диктором (ElevenLabs) | 1 звезда (НЕДОСТУПНО для Free Trial!) |
| Мультик | 5 звёзд (НЕДОСТУПНО для Free Trial!) |

### Механика Free Trial:
1. Пользователь получает 7 дней доступа и может создать 3 сказки
2. AI Audio и AI Cartoon заблокированы для Free Trial
3. После 3 сказок показывается модалка с предложением оформить подписку за $8/первый месяц
4. После Free Trial нужна платная подписка для продолжения

## Lava.top Offer IDs
- **Free Trial ($0):** `906b87bc-0fd3-4eca-a8a2-71b654e52ba5`
- **Monthly/Yearly ($8->$29/$189):** `0f1994eb-ee95-4c4b-85ed-4437ed82ba49`
