...
export function AuthModal({ isOpen, onClose, onSuccess, redirectUrl, initialMode = "signin" }: AuthModalProps) {
  ...
  useEffect(() => {
    if (!isOpen) {
      ...
      setMode(initialMode);
      // For signup, start with child-info step
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div
        className={`relative glass-card-strong p-6 sm:p-8 w-full mx-2 max-h-[90vh] overflow-y-auto ${
