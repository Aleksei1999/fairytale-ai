    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-sky-50">
      ...
      <main className="pt-28 pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Privacy Policy FairyTale AI Tech</h1>
          <p className="text-gray-600 mb-8">Effective Date: December 25, 2025</p>
          ...
          <div className="glass-card p-6 sm:p-8 space-y-6 text-gray-700">
            ...
            <section>
              ...
              <h3 className="font-bold text-gray-800 mb-2">A. Information Provided by You (Parent/Guardian)</h3>
              ...
              <h3 className="font-bold text-gray-800 mb-2 mt-4">B. Information Collected Automatically</h3>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-3">3. Use of Artificial Intelligence (AI) Technologies</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-3">4. Children&apos;s Privacy (COPPA and GDPR-K)</h2>
              <p className="mb-3 font-semibold text-gray-800">This is a key section of our policy. We take the protection of minors&apos; data seriously.</p>
              ...
              <p className="mt-3 bg-blue-50 border border-blue-200 rounded-lg p-3 text-blue-800">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-3">5. Disclosure of Information to Third Parties</h2>
