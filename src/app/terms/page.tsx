      ...
      <main className="pt-28 pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="glass-card p-6 sm:p-8 space-y-6 text-gray-700">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-3">1. About the Service</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-3">2. Account and Access</h2>
              <p className="mb-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-3">3. Use of Artificial Intelligence (AI)</h2>
              <p className="mb-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-3">4. Subscription and Payments</h2>
              <p className="mb-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-3">7. Disclaimer of Liability (Important)</h2>
              <p className="mb-2">
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-3">10. Applicable Law and Dispute Resolution</h2>
              <p className="mb-2">
