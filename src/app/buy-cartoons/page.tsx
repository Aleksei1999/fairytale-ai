...
const CARTOON_PACKAGES = [
  ...
  },
  {
    ...
    price: "$29.90",
    pricePerCredit: "$7.47",
    description: "Perfect for 1 month",
    popular: true,
  },
  {
    id: "season",
...
export default function BuyCartoons() {
  ...
  const handlePurchase = async (packageId: string) => {
    ...
    try {
      const response = await fetch("/api/payment/create-cartoon", {
        method: "POST",
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-purple-100 to-pink-100 border border-purple-200 mb-6">
              ...
              <span className="text-sm font-medium text-purple-700">
                {cartoonCredits !== null ? `You have ${cartoonCredits} cartoon credits` : "Loading..."}
              </span>
            </div>
            <h1 className="font-display text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Turn Stories into <span className="gradient-text">Cartoons</span>
            </h1>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Transform your fairy tales into beautiful animated videos that your child will love!
            </p>
          </div>
          ...
          <div className="glass-card p-6 mb-8">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">Create a story</p>
                  <p className="text-sm text-gray-600">Generate a fairy tale as usual</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold flex-shrink-0">
                ...
                <div>
                  <p className="font-medium text-gray-900">Request cartoon</p>
                  <p className="text-sm text-gray-600">Click "Make a Cartoon" button</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold flex-shrink-0">
                ...
                <div>
                  <p className="font-medium text-gray-900">Get your video</p>
                  <p className="text-sm text-gray-600">Receive in 10-15 minutes</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-6 mb-8">
            {CARTOON_PACKAGES.map((pkg) => (
              <div
                key={pkg.id}
                className={`glass-card p-6 relative ${
                  pkg.popular ? "border-2 border-purple-400 shadow-lg" : ""
                }`}
              >
                {pkg.popular && (
                ...
                <div className="text-center mb-4">
                  ...
                  <h3 className="font-bold text-xl text-gray-900">
                    {pkg.credits} {pkg.credits === 1 ? "Cartoon" : "Cartoons"}
                  </h3>
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-500">{pkg.pricePerCredit} per cartoon</p>
                </div>
          ...
          <div className="glass-card p-6 text-center">
            <p className="text-gray-600 text-sm">
              <span className="font-semibold text-gray-900">Note:</span> Cartoon credits are valid for 90 days from purchase.
              Each cartoon takes 10-15 minutes to generate.
            </p>
          </div>
        </div>
      </main>
